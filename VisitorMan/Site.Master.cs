...
namespace VisitorMan
{
    public partial class SiteMaster : MasterPage
    {
        ...
        protected void Unnamed_LoggingOut(object sender, LoginCancelEventArgs e)
        {
            ...
            command.CommandText = "UPDATE tblLogs SET [Last Logout] = @last WHERE [Network Login] = @login";
            command.Parameters.AddWithValue("@last", date.ToString());
            command.Parameters.AddWithValue("@login", Context.User.Identity.GetUserName());
